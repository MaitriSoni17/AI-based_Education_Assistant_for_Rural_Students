...
const CAREER_PAGE_TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    matchmakerBtn: "Discover Matchmaker",
  ...
  hi: {
    ...
    matchmakerBtn: "करियर मैचमेकर खोजें",
  ...
  gu: {
    ...
    matchmakerBtn: "કારકિર્દી મેચમેકર શોધો",
  ...
  mr: {
    ...
    matchmakerBtn: "करिअर मॅचमेकर शोधा",
    aiGuidanceTitle: "स्वामी AI स्मार्ट मार्गदर्शन",
  ...
  ta: {
    ...
    matchmakerBtn: "தொழில் மேட்ச்மேக்கர்",
  ...
  te: {
    ...
    matchmakerBtn: "కెరీర్ మ్యాచ్‌మేకర్",
